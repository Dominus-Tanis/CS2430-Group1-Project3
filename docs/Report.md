...
From Dallin: "I first took 2420 nearly two years ago, where I learned about Dynamic Programming for the first (and only) time, and it was my first time trying to recall something I studied in class but haven't used in real life until years later. I think this is something that's going to happen a lot once I enter the industry and have to remember what I learn in this and other classes, so it's helpful to have reference for what things are going to stick with me and what things I'm going to have to relearn through wikipedia or examples. In this case, I was able to reconstruct the backtrace algorithm but couldn't remember how the table was formatted - I forgot the easy part but figured out the hard part once I got started."
